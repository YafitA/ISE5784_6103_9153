...
public class TeapotTest {
     ...
     */
    private final ImageWriter imageWriter = new ImageWriter("teapot", 1200, 1200);
    ...
    public void teapot() {
        ...
        scene.geometries.add(new Sphere(new Point(0, 0, 0), 100)
        ...
        for (int i = 0; i < 360; i += 10) {
            ...
            scene.geometries.add(new Sphere(new Point(x, y, z), 5)
